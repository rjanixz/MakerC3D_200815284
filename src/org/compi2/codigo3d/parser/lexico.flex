...
<YYINITIAL> {MENORIGUALQUE} { return new Symbol(sym.MENORIGUALQUE, yyline, yycolumn, null); }
<YYINITIAL> {MAYORIGUALQUE} { return new Symbol(sym.MAYORIGUALQUE, yyline, yycolumn, null); }
